...
function phoneConnect() {
	...
	console.log("size: " + innerClassElements.length);
	if(innerClassElements.length>0){
		innerClassElements[0].onload = function() {
...
function phoneRefresh() {
	...
	//}
	// console.log("phoneRefresh-Id: " + id);
...
function phoneDisconnect() {
	var innerClassElements = document.querySelectorAll(".phoneInnerClass");
	for(var i=0; i<innerClassElements.length; i++){
		innerClassElements[i].onload = null;
		innerClassElements[i].setAttribute("src", "images/black.png");
	}
